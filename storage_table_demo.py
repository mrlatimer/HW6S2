...
resourcegroup_name = 'latimer'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'latimer'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'eastus'
...
print('Created entry for Chevy Impala...')
...
car.price = 3000
table_service.insert_entity('itemstable', car)
print('Created entry for Nissan Frontier...')
...
car.price = 1000
table_service.insert_entity('itemstable', car)
print('Created entry for Chevrolet S10...\n')
...
print('Created entry for a large Folgers Medium Roast...\n')
time.sleep(1)
...
coffee.cupsize = 'medium'
coffee.price = 1.09
table_service.insert_entity('itemstable', coffee)
print('Created entry for a medium Maxwell House Regular...\n')
time.sleep(1)
...
items = table_service.query_entities('itemstable', filter="PartitionKey eq 'coffeeinventory'", select='brand,flavor,cupsize,price')
for item in items:
